...
$hasBike          = clean($data['hasBike'] ?? 'N/A');
$bikeModel        = clean($data['bikeModel'] ?? 'N/A');
$bikeReg          = clean($data['bikeReg'] ?? 'N/A');
$drivingLicense   = clean($data['drivingLicense'] ?? 'N/A');
$experience       = clean($data['experience'] ?? 'N/A');
$employmentStatus = clean($data['employmentStatus'] ?? 'N/A');
$message          = clean($data['message'] ?? '');
$preferredCompany = isset($data['preferredCompany']) && is_array($data['preferredCompany'])
    ? implode(', ', array_map('clean', $data['preferredCompany']))
    : 'None selected';
$jobType = isset($data['jobType']) && is_array($data['jobType'])
    ? implode(', ', array_map('clean', $data['jobType']))
    : 'None selected';
...
if ($hasBike === 'Yes') {
    ...
    <tr style='background:#fff;'>
        <td style='padding:13px 18px;border-bottom:1px solid #f0f0f0;color:#888;font-size:14px;width:42%;'>&#x1F6F5; Bike Model &amp; Reg</td>
        <td style='padding:13px 18px;border-bottom:1px solid #f0f0f0;color:#1a1a1a;font-size:14px;font-weight:600;'>{$bikeModel} &nbsp;|&nbsp; {$bikeReg}</td>
    </tr>";
}
$msgRow = '';
if ($message) {
    ...
    <tr style='background:#fafafa;'>
        <td style='padding:13px 18px;color:#888;font-size:14px;vertical-align:top;'>&#x1F4AC; Message</td>
        <td style='padding:13px 18px;color:#1a1a1a;font-size:14px;font-weight:600;'>{$message}</td>
    </tr>";
}
        ...
        <tr>
          <td style='background:#D81B60;padding:14px 40px;text-align:center;'>
            <p style='margin:0;color:#ffffff;font-size:15px;font-weight:700;letter-spacing:2px;text-transform:uppercase;'>
              &#x1F4CB;&nbsp; New Delivery Executive Application
            </p>
          </td>
        </tr>
        ...
        <tr>
          <td style='background:#ffffff;padding:36px 40px 28px 40px;'>
            ...
            <p style='margin:0 0 28px 0;color:#666;font-size:15px;line-height:1.6;'>
              A new candidate has submitted a <strong>Delivery Executive Application</strong> through the DropyHub website. Please find the details below.
            </p>
            ...
            <table width='100%' cellpadding='0' cellspacing='0' style='border-radius:10px;overflow:hidden;border:1px solid #eee;'>
              ...
              <tr style='background:#fafafa;'>
                <td style='padding:13px 18px;border-bottom:1px solid #f0f0f0;color:#888;font-size:14px;'>&#x2709;&#xFE0F; Email ID</td>
                <td style='padding:13px 18px;border-bottom:1px solid #f0f0f0;color:#1a1a1a;font-size:14px;font-weight:600;'>{$email}</td>
              </tr>
              <tr style='background:#fff;'>
              ...
              <tr style='background:#fafafa;'>
                <td style='padding:13px 18px;border-bottom:1px solid #f0f0f0;color:#888;font-size:14px;'>&#x1F6B2; Has Bike?</td>
                <td style='padding:13px 18px;border-bottom:1px solid #f0f0f0;color:#1a1a1a;font-size:14px;font-weight:600;'>{$hasBike}</td>
              </tr>
              {$bikeRow}
              <tr style='background:#fff;'>
                <td style='padding:13px 18px;border-bottom:1px solid #f0f0f0;color:#888;font-size:14px;'>&#x1F4C4; Driving License</td>
                <td style='padding:13px 18px;border-bottom:1px solid #f0f0f0;color:#1a1a1a;font-size:14px;font-weight:600;'>{$drivingLicense}</td>
              </tr>
              <tr style='background:#fafafa;'>
                <td style='padding:13px 18px;border-bottom:1px solid #f0f0f0;color:#888;font-size:14px;'>&#x1F3E2; Preferred Company</td>
                <td style='padding:13px 18px;border-bottom:1px solid #f0f0f0;color:#1a1a1a;font-size:14px;font-weight:600;'>{$preferredCompany}</td>
              </tr>
              <tr style='background:#fff;'>
                <td style='padding:13px 18px;border-bottom:1px solid #f0f0f0;color:#888;font-size:14px;'>&#x1F4BC; Job Type</td>
                <td style='padding:13px 18px;border-bottom:1px solid #f0f0f0;color:#1a1a1a;font-size:14px;font-weight:600;'>{$jobType}</td>
              </tr>
              <tr style='background:#fafafa;'>
                <td style='padding:13px 18px;border-bottom:1px solid #f0f0f0;color:#888;font-size:14px;'>&#x2B50; Experience</td>
                <td style='padding:13px 18px;border-bottom:1px solid #f0f0f0;color:#1a1a1a;font-size:14px;font-weight:600;'>{$experience}</td>
              </tr>
              <tr style='background:#fff;'>
                <td style='padding:13px 18px;border-bottom:1px solid #f0f0f0;color:#888;font-size:14px;'>&#x1F4CB; Employment Status</td>
                <td style='padding:13px 18px;border-bottom:1px solid #f0f0f0;color:#1a1a1a;font-size:14px;font-weight:600;'>{$employmentStatus}</td>
              </tr>
              {$msgRow}
            </table>
            ...
            <div style='background:#fff8e1;border-left:4px solid #ffc107;border-radius:6px;padding:14px 18px;margin-top:28px;'>
              <p style='margin:0;color:#7c6000;font-size:14px;'>&#x26A1; <strong>Action Required:</strong> Please contact this applicant within <strong>24 hours</strong> to complete their onboarding process.</p>
            </div>
...
$subject = "&#x1F4CB; New Delivery Application: {$name} | DropyHub";
